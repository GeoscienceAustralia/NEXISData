...
aws s3api put-object-acl --bucket nexis.et.web --key app --grant-read-acp uri=http://acs.amazonaws.com/groups/global/AllUsers
aws s3api put-object-acl --bucket nexis.et.web --key node_modules --grant-read-acp uri=http://acs.amazonaws.com/groups/global/AllUsers